...
Wallock::GaugedValue gvPhotoReadout("photoValue", 60, 550, 10, false);
...
RotaryEncoderWith`Button rotary(
...
#if ENABLE_ENCODER_RGB
Wallock::App app(pinout, state, rotary, button, matrix, colorManager);
#else
Wallock::App app(pinout, state, rotary, button, matrix);
#endif
...
void setup() {
  ...
  Wallock::callBack_displayCurrentTime();
